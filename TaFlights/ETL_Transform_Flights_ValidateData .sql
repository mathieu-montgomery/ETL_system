...
truncate table TaFlights_Validate_Pilot_Initials;
...
insert into TaFlights_Error (idError, launchtime, club, dateError, step, dataError, typeError, status)        
...
-- Validate the pilote
insert into TaFlights_Validate_Pilot_Initials (LAUNCHTIME,  PLANEREGISTRATION,  PILOT1INIT,  PILOT2INIT
                                          ,LAUNCHAEROTOW,  LAUNCHWINCH,  LAUNCHSELFLAUNCH,  CABLEBREAK,  CROSSCOUNTRYKM,  CLUB, FLIGHT_DURATION)
...
insert into TaFlights_Validate_Launch_Type (LAUNCHTIME, FLIGHT_DURATION, PLANEREGISTRATION, PILOT1INIT, PILOT2INIT, LAUNCH_TYPE, 
  ...
  from TaFlights_Validate_Pilot_Initials
